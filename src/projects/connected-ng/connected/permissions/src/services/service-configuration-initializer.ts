...
import { CLAIM_EXTENSIONS_SERVICE_CONFIG, ClaimExtensionsServiceConfiguration } from './claims/claim-extensions-service';
...
export class CorePermissionsConfigurationProvider extends ConfigurationProvider {
	...
	static getConfigurationTokens(): any[] {
		return [
			...
			CLAIM_EXTENSIONS_SERVICE_CONFIG,
	...
	static getConfigurationTokenProviders(): Provider[] {
		return [
			...
			{ provide: CLAIM_EXTENSIONS_SERVICE_CONFIG, useValue: new ClaimExtensionsServiceConfiguration() },
